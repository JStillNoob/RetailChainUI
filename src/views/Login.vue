    ...
    <div class="auth-left">
      ...
      <div class="auth-left-content">
        ...
        <div class="auth-illustration">
          <div class="auth-info-card">
            <div class="aic-header">
              ...
              <div>
                <div class="aic-title">Supply Chain Overviewsdasdsadasdasdasdsda</div>
            ...
            <div class="aic-chart">
              <svg viewBox="0 0 200 50" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <path
                  d="M0,35 C25,32 50,22 75,20 C100,18 125,28 150,24 C175,20 187,15 200,12"
                  stroke="#3B82F6"
                  stroke-width="2"
                  fill="none"
                />
                <path
                  d="M0,35 C25,32 50,22 75,20 C100,18 125,28 150,24 C175,20 187,15 200,12 L200,50 L0,50Z"
                  fill="url(#lg1)"
                />
              </svg>
            </div>
        ...
        <div class="auth-left-footer">
          <p>
            "RetailChain transformed how we manage our 5 stores. Inventory is always accurate and
    ...
    <div class="auth-right">
      <div class="auth-form-wrapper">
        ...
        <form @submit.prevent="handleLogin" class="auth-form" id="login-form">
          ...
          <button type="submit" class="rc-btn-primary" :disabled="loading" id="login-submit-btn">
...
.auth-divider::after {
  ...
  flex: 1;
  height: 1px;
  background: rgba(180, 192, 230, 0.4);
}
...
.social-btn {
  ...
  gap: 8px;
  background: #fff;
  border: 1.5px solid rgba(180, 192, 230, 0.5);
  border-radius: 10px;
  padding: 10px 16px;
  font-family: inherit;
  font-size: 13.5px;

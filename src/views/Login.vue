        ...
        <div class="w-full max-w-[400px]">
          ...
          <div class="grid grid-cols-1 gap-4 fade-up delay-400">
            <button
              ...
              class="social-btn w-full h-[48px] inline-flex items-center justify-center gap-2.5 rounded-[10px] border border-slate-200 bg-white text-sm font-bold text-slate-700 hover:bg-slate-50 hover:border-slate-300 disabled:opacity-60 disabled:cursor-not-allowed"
            >
              <i v-if="googleLoading" class="ph ph-circle-notch animate-spin text-lg text-slate-500"></i>

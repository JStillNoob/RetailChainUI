...
import { getTopProducts, exportReportPdf } from '../../services/reportsService.ts'
...
async function doExport() {
  ...
  exportError.value = ''
  try {
    await exportReportPdf('top-products')
  } catch {
  ...
  <div class="report-card">
    <div class="report-card-header">
      ...
      <div style="display:flex;gap:8px;align-items:center">
        <button class="btn-ghost btn-sm" @click="load"><i class="ph ph-arrows-clockwise"></i></button>
